...
import { Lock, User, AlertCircle, Eye, EyeOff, Package } from "lucide-react";

export function PackLoginForm() {
  const router = useRouter();
  const [username, setUsername] = useState("pack");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/pack/login", {
        method: "POST",
